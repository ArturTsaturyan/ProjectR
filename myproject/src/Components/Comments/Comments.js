...
import SingleComment from '../../Components/SingleComments/SingleComments'; //իմպորտ անելուց հետո մեր կոմպոնենտը
                                             //տեղափոխվում ենք app.js
...
function Comments(props){
    ...
    const handeleSubmit = (e) => {//submiti ժամանակ մենք form-ի մենք ատմենա ենք տալիս իրա դեֆոլդային վիճակը
